% function steadyStateProbabilitySNIR = getSteadyStateProbabilitySNIRcdf(nu,sigma,nChanLev,SnirThreshold)
function steadyStateProbabilitySNIR = getSteadyStateProbabilitySNIRcdf(nu,sigma)
   % steadyStateProbabilitySNIR = zeros(1,nChanLev);   % % SNIR's iterval thresholds
    steadyStateProbabilitySNIR = ...
        quadgk(@getSteadyStateProbabilityIntervalSNIR,-27.4721,-26.0035,'AbsTol',10*eps,'RelTol',100*eps);
